-- =============================================================================
-- SIMPLE POLICY PAYMENTS TABLE MIGRATION
-- PostgreSQL migration for policy payment tracking (without dependencies)
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS policy_payments (
    ...
    partner_id INTEGER, -- Removed FK constraint for now
...
SELECT 'Policy payments table created successfully!' as result;